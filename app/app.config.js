...
function routes($stateProvider, $urlRouterProvider) {
    ...
    var states = [
        ...
        {
            name: 'founder',
            label: 'Founder & His Story',
            base: 'founder',
            auth: false,
            restricted:false,
            url: '/founder',
            templateUrl: 'app/about/founder.html',
            controller: 'aboutController'
        },
        {
            name: 'story',
            label: 'The Oxygen Story',
            base: 'story',
            auth: false,
            restricted:false,
            url: '/story',
            templateUrl: 'app/about/story.html',
            controller: 'aboutController'
        },
        {
            name: 'videogallery',
            ...
            resolve: {
                DATA: function(ApiService, $stateParams) {
                  return ApiService.videos($stateParams.id);
                }
            }
        },
        {
        ...
        },
        {
            ...
            resolve: {
                DATA: function(ApiService, $stateParams) {
                  return ApiService.blogs($stateParams.id);
                }
            }
        },
        {
            ...
            restricted:false,
            url: '/blogdetail/:id',
            templateUrl: 'app/blogs/blogdetail.html',
            controller: 'blogsController',
            resolve: {
                DATA: function(ApiService, $stateParams) {
                  return ApiService.blogs($stateParams.id);
